...
const disable_automatic_slideshow = document.querySelector(".checkbox-container input");
let checked_disable_automatic_slideshow = disable_automatic_slideshow.checked;
...
function direct_image_change(event) {
    ...
    // Debug: For testing whether logic working correctly or not ----------------> Working correctly
...
function which_button(event, which_button) {
    ...
    // Debug: Just checking if the arrows are working correctly or not -----------> Working Correctly
...
function image_slideshow(event, number) {
    ...
    // Debug: For checking whehter working correctly or not -------------------> Working Correctly
    // console.log(event);
    // console.log(number);
    ...
    // Debug: For checking whether the logic is working correctly or not ---------------> Working correctly 
...
function click_next_arrow() {
    checked_disable_automatic_slideshow = disable_automatic_slideshow.checked;

    if (checked_disable_automatic_slideshow)
        return;

    // Debug: For debugging purpose of removing the automatic image-slideshow
    // console.log(checked_disable_automatic_slideshow);
...
setInterval(click_next_arrow, 5000);